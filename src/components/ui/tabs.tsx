...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex bg-slate-50 w-fit mx-auto p-2 rounded-full flex-row items-center justify-center [perspective:1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar max-w-full",
          containerClassName
        )}
      >
